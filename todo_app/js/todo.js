...
function get_todos() {
    ...
    /*if the input is not null them JSON.parse will communicate with the web browser to make the task a JS object*/
    if (todos_str !== null) {
...
function remove () {
    ...
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    /*this looks in the show() how to display a removes item on the screen */
    show();
...
/*this will keep the inputs displayed permanently onm the screen*/
show();
